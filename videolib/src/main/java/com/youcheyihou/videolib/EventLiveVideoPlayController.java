...
/**
 * 仿腾讯视频热点列表页播放器控制器.
 * 由TxVideoPlayerController改造而来，适配活动直播的UI
 */
public class EventLiveVideoPlayController extends NiceVideoPlayerController implements View.OnClickListener,
    ...
    private LinearLayout mEventLiveReplayTipsLayout;//重放视频时才显示
    private TextView mEventTitleTv;
    private LinearLayout mVideoUploadingLayout;
    private LinearLayout mVideoReplayLayout;
    ...
    private TextView mNotBeginTips;
    private TextView mPauseTips;
...
//    private TextView mLength;
    ...
    private void init() {
        LayoutInflater.from(mContext).inflate(R.layout.event_live_player_controller, this, true);
        ...
        mEventLiveReplayTipsLayout = (LinearLayout) findViewById(R.id.event_live_replay_tips_layout);
        mEventTitleTv = (TextView) findViewById(R.id.event_title_tv);
        mVideoUploadingLayout = (LinearLayout) findViewById(R.id.video_uploading_layout);
        mVideoReplayLayout = (LinearLayout) findViewById(R.id.video_replay_layout);
        mReplayBtn = (ImageView) findViewById(R.id.replay_btn);
        ...
        mNotBeginTips = (TextView) findViewById(R.id.not_begin_tips);
        mPauseTips = (TextView) findViewById(R.id.pause_tips);
//        mLength = (TextView) findViewById(R.id.length);
    ...
    public void setShowProgressBar(boolean isShowProgressBar) {
        mEventLiveReplayTipsLayout.setVisibility(isShowProgressBar ? VISIBLE : INVISIBLE);
    }
     ...
     * @param isReplyTips
     */
    public void setReplayTips(boolean isReplyTips) {
        mVideoReplayLayout.setVisibility(isReplyTips ? VISIBLE : GONE);
        mReplayBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mReplayClickListener != null) {
                    mReplayClickListener.onReplayBtnClick();
                }
            }
        });
    }
    ...
    public void setUploading(boolean isUploading) {
        mVideoUploadingLayout.setVisibility(isUploading ? VISIBLE : GONE);
    }


    public void setNotBegin(boolean isNotBegin) {
        mNotBeginTips.setVisibility(isNotBegin ? VISIBLE : GONE);
        mEventTitleTv.setVisibility(VISIBLE);
    }

    /**
     * 直播未开始时，设置一下直播名称
     */
    public void setNotBeginTitle(String title) {
        mEventTitleTv.setText(title);
    }

    public void setPause(boolean isPause) {
        mPauseTips.setVisibility(isPause ? VISIBLE : GONE);
    }
    ...
    protected void onPlayStateChanged(int playState) {
        ...
        switch (playState) {
            ...
            case NiceVideoPlayer.STATE_PLAYING:
                ...
                mRestartPause.setImageResource(R.mipmap.btn_vedio_pause);
                startDismissTopBottomTimer();
                break;
            case NiceVideoPlayer.STATE_PAUSED:
                mLoading.setVisibility(View.GONE);
                mRestartPause.setImageResource(R.mipmap.btn_vedio_replay);
