...
/**
 * [参考] https://github.com/xiaoyanger0825/NiceVieoPlayer
 * 播放器
 */
public class NiceVideoPlayer extends FrameLayout implements INiceVideoPlayer, TextureView.SurfaceTextureListener {
    ...
    public static final int MODE_TINY_WINDOW = 12;//小窗口模式
    //播放器类型
    /**
     * IjkPlayer已经可以使用
     */
    public static final int TYPE_IJK = 111;//IjkPlayer
    public static final int TYPE_NATIVE = 222;//MediaPlayer
    ...
    /**
     * @param playerType 放器类型: IjkPlayer or MediaPlayer.
     */
    ...
    /**
     * @param doGc 是否主动gc回收资源
     */
    public void release(boolean doGc) {
        // 保存播放位置
