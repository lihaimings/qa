...
public class StringUtils {
    ...
    public static List<String> spliteString(String targetStr){
        String[] strings = targetStr.split("rofjy8427");
        return Arrays.asList(strings);
    }

    public static String getImgString(String s){
        return s.substring(4);
    }
    public static String getVideoString(String s){
        return s.substring(6);
    }

    public static String[] getVideoImage(String s){
        String string = s.substring(6);
        return string.split("ry98jhf01");
    }



    /**
     * @param targetStr contentString 要处理的字符串
