 ...
 * Copyright (c) 有车以后
 *
 * @description: (毛玻璃效果 ： 高斯模糊算法blur)
 * @author：yanshaowei
 * @date 2019/9/9 下午2:31 
 */
public class FastBlurUtil {
     ...
     * @param isDownScale 是否降s `低等级，优化效率（建议开启）
     * @param radius      模糊值
     */
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN)
    public static void doBlur(Context context, Bitmap bkg, View view, boolean isDownScale, int radius) {
        float scaleFactor = 1;
        if (isDownScale) {
